...
if(computer == user):
    ...
    '''
    if(computer == -1 and user == 1):   (computer - you) = -2
        print("You Win!")

    elif(computer == -1 and user == 0):  (computer - you) = -1
        print("You Lose!")

    elif(computer == 1 and user == -1):  (computer - you) = 2
        print("You Lose!")

    elif(computer == 1 and user == 0):  (computer - you) = 1
        print("You Win!")

    elif(computer == 0 and user == -1):  (computer - you) = 1
        print("You Win!")
